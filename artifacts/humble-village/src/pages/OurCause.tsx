          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '80px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }} className="location-grid-0">
              ...
              <div>
                ...
                <p style={{ fontFamily: 'Figtree, sans-serif', fontSize: '16px', lineHeight: 1.8, color: '#574C3F', marginBottom: '24px' }}>We provide training sessions to families on home hygiene and healthcare, food production and cooking demonstrations, as well as offering clinical care to expectant mothers. Here our nurses monitor monthly progress of malnourished babies on the nutrition program.</p>
                <p style={{ fontFamily: 'Figtree, sans-serif', fontSize: '16px', lineHeight: 1.8, color: '#574C3F', marginBottom: '24px' }}>Located in the heart of Senahu — a town reached by a winding, six-hour mountain drive — our center serves as a critical hub for mothers traveling up to three hours to reach us. It offers both clinical care and education, staffed by nurses, outreach workers, and medical educators. Mothers bring their children for monthly weigh-ins and nutrition tracking, receiving Incaparina and empowering education such as home hygiene and healthcare, food production and cooking demonstrations with home-grown, nutrient-rich foods. The center also features a small garden providing plant starts for families to grow at home, and partners with ADP for teen abuse prevention and CARE International for micro-business skills for young mothers. Prenatal care received in our medical clinic is especially important to expectant mothers and has life-changing implications for both them and their babies.</p>
