    ...
    <main>
      ...
      <section style={{ paddingTop: '80px', background: '#F8F3EC' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)' }} className="about-photo-grid">
          ...
          <img src={`${BASE}/images/about-cooking.webp`} alt="Women cooking at Solly kitchen" style={{ width: '100%', height: '480px', objectFit: 'cover', objectPosition: 'center 30%', display: 'block' }} />
