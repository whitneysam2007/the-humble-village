            ...
            <div style={{
              ...
              <div style={{ order: i % 2 === 0 ? 0 : 1 }}>
                {story.beforePhoto && (story as any).noLabels ? (
                  ...
                  <div style={{ display: 'flex', gap: '12px' }}>
                    <div style={{ flex: 1 }}>
                      <p style={{ fontFamily: 'Figtree, sans-serif', fontSize: '10px', fontWeight: 700, letterSpacing: '0.18em', color: i % 2 === 0 ? '#E8B48A' : '#574C3F', marginBottom: '6px', textAlign: 'center', textTransform: 'uppercase' }}>Before</p>
                      <img
                        src={`${BASE}/images/${story.beforePhoto}`}
                    ...
                    <div style={{ flex: 1 }}>
                      <p style={{ fontFamily: 'Figtree, sans-serif', fontSize: '10px', fontWeight: 700, letterSpacing: '0.18em', color: i % 2 === 0 ? '#E8B48A' : '#574C3F', marginBottom: '6px', textAlign: 'center', textTransform: 'uppercase' }}>After</p>
                      <img
                        src={`${BASE}/images/${story.slide}`}
