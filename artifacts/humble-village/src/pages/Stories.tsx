  ...
  return (
    <main>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', textAlign: 'center' }}>
        <img
          src={`${BASE}/images/home-interior-3.webp`}
          alt="A Q'eqchi' Maya mother and child in their home"
          style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center center' }}
        />
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to right, rgba(20,14,8,0.82) 0%, rgba(20,14,8,0.72) 40%, rgba(20,14,8,0.45) 70%, rgba(20,14,8,0.25) 100%)' }} />
